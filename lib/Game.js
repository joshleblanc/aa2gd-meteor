...
if(Meteor.isServer) {
  ...
  Meteor.methods({
    "games.sorted"(serverId) {
      ...
      const counts = {};
      games.sort((a, b) => {
        counts[a._id] = counts[a._id] || countUsers(serverId, a._id);
        counts[b._id] = counts[b._id] || countUsers(serverId, b._id);
        return counts[b._id] - counts[a._id];
      });
      return games;
    }
  });
